...
const SessionLogsController = require("../../controllers/common_utilities/SessionLogsController.js");
...
router.post("/add_session_logs", urlencodedParser, function(
    request,
    response
) {
    var jsonObject_ = {
...
router.post(
    "/get_number_of_session_logs_records",
    urlencodedParser,
